...
public class Sorting {
     ...
     * Modified to end once list is sorted, done by using a swap incrementer
     * to stop unnecessary passes.
     * Tracers added to track process of sorting.
     * @param <T>
     * @param data the array to be sorted
     */
    public static <T extends Comparable<T>>
        ...
        while(sorted == false){
            ...
            System.out.println("Prior to pass " + count + " Sorted = " + sorted);
            ...
            System.out.println("End of pass " + count + " Sorted = " + sorted);
            count++;
            swap = 0;
            position--;
            }
